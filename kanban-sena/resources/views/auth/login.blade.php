                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input id="password" type="password" name="password" required
                                ...
                                placeholder="••••••••">
                            <button type="button" onclick="togglePasswordVisibility()" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-sena-gray400 hover:text-sena-gray600 transition-colors">
